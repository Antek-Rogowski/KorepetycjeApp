...
void AuthManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AuthManager::*)(const QString & , const QString & , const QString & )>(_a, &AuthManager::loginSuccess, 0))
            return;
...
// SIGNAL 0
void AuthManager::loginSuccess(const QString & _t1, const QString & _t2, const QString & _t3)
{
